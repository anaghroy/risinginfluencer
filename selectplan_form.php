...
<html lang="en">
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/select_plan.css">
    </head>
    ...
    <body>
                ...
                <img src="images/service/service renewal form.jpg" alt="" class="home-img">
                     ...
                     <div class="home-details">
                            <div class="home-text">
                                ...
                                <h2 class="homeTitle">What we do is far imporrant than <br> What we say</h2>
                           </div>     
                     </div>
            </div>
        </section>
        ...
        <div class="container">
            ...
            <form action="existing_service.php" method="POST" enctype="multipart/form-data">
                <label  for="title"><b><h3><center>Select Your Plan</h3></center></b></label><br><br>
                        ...
                        <input type="text" id="customer_id" name="customer_id" value="<?php echo uniqid('RISING'); ?>" readonly>
                ...
                <input type="submit" value="Submit" id="submission_date" name="submission_date"><br>
