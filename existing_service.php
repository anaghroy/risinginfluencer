...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO existing_service (user_name, customer_id, company_name, company_address, phoneno, email, select_plan, plan_duration, amount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
